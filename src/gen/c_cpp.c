...
static void render_type_prefix(struct apigen_Stream const stream, struct apigen_Type const * const type, enum RenderMode render_mode, size_t indent)
{
    ...
    switch(type->id)
    {
        ...
        case apigen_typeid_anyopaque:   apigen_io_print(stream, "void"); break;
        case apigen_typeid_opaque:      apigen_io_print(stream, "void"); break; // opaque types can be declared void and will get named void-pointers then
        case apigen_typeid_bool:        apigen_io_print(stream, "bool"); break;
        case apigen_typeid_uchar:       apigen_io_print(stream, "unsigned char"); break;
        case apigen_typeid_ichar:       apigen_io_print(stream, "signed char"); break;
        case apigen_typeid_char:        apigen_io_print(stream, "char"); break;

        case apigen_typeid_u8:          apigen_io_print(stream, "uint8_t"); break;
        case apigen_typeid_u16:         apigen_io_print(stream, "uint16_t"); break;
        case apigen_typeid_u32:         apigen_io_print(stream, "uint32_t"); break;
        case apigen_typeid_u64:         apigen_io_print(stream, "uint64_t"); break;
        case apigen_typeid_usize:       apigen_io_print(stream, "uintptr_t"); break;
        case apigen_typeid_c_ushort:    apigen_io_print(stream, "unsigned short"); break;
        case apigen_typeid_c_uint:      apigen_io_print(stream, "unsigned int"); break;
        case apigen_typeid_c_ulong:     apigen_io_print(stream, "unsigned long"); break;
        case apigen_typeid_c_ulonglong: apigen_io_print(stream, "unsigned long long"); break;

        case apigen_typeid_i8:          apigen_io_print(stream, "int8_t"); break;
        case apigen_typeid_i16:         apigen_io_print(stream, "int16_t"); break;
        case apigen_typeid_i32:         apigen_io_print(stream, "int32_t"); break;
        case apigen_typeid_i64:         apigen_io_print(stream, "int64_t"); break;
        case apigen_typeid_isize:       apigen_io_print(stream, "intptr_t"); break;
        case apigen_typeid_c_short:     apigen_io_print(stream, "short"); break;
        case apigen_typeid_c_int:       apigen_io_print(stream, "int"); break;
        case apigen_typeid_c_long:      apigen_io_print(stream, "long"); break;
        case apigen_typeid_c_longlong:  apigen_io_print(stream, "long long"); break;

        case apigen_typeid_f32:         apigen_io_print(stream, "float"); break;
        case apigen_typeid_f64:         apigen_io_print(stream, "double"); break;
        ...
        case apigen_typeid_union:
            ...
            if(type->id == apigen_typeid_struct) {
                apigen_io_print(stream, "struct ");
            }
            else {
                apigen_io_print(stream, "union ");
            }
...
bool apigen_render_c(struct apigen_Stream const stream, struct apigen_MemoryArena * const arena, struct apigen_Diagnostics * const diagnostics, struct apigen_Document const * const document)
{
    ...
    for(size_t i = 0; i < document->type_count; i++)
    {
        ...
        apigen_io_print(stream, "typedef ");
